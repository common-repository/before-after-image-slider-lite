...
define('BEFORE_AFTER_IMAGE_SLIDER_LITE_VERSION', '2.2.0');
...
function wpbaimages_enque_scripts_and_styles() {
    wp_enqueue_style('nouislider-css', plugins_url('libs/nouislider-14.6.2/nouislider.css', __FILE__), false, '14.6.2');
    wp_enqueue_script('nouislider-js', plugins_url('libs/nouislider-14.6.2/nouislider.js', __FILE__), array('jquery'), '14.6.2', false);
